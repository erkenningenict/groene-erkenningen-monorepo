...
describe('examenMomenten()', () => {
  it('should return mock data', async () => {
    ...
    const xml = fs.readFileSync(
      path.resolve(__dirname, '../../mocks/alle-examen-momenten-new.xml'),
      'utf-8',
    )
    ...
    expect(spy).toBeCalledWith(
      'https://mijn.ibki.nl/main/interfaces/soap11/apialleexamenmomenten?wsdl',
      'http://www.triggre.com/2018/soap/Service/APIAlleExamenmomenten',
      'triggre-Main',
      'test',
      `<soap:APIAlleExamenmomenten><soap:Einddatum>undefined</soap:Einddatum><soap:Begindatum>undefined</soap:Begindatum><soap:OrganisatieCode>undefined</soap:OrganisatieCode><soap:TypeCertificaat>APK</soap:TypeCertificaat><soap:TypeBijeenkomst>Kennisbijeenkomst</soap:TypeBijeenkomst></soap:APIAlleExamenmomenten>`,
      'label: APK, type bijeenkomst: Kennisbijeenkomst',
    )
  ...
  describe('alleExamenMomentenToJs()', () => {
    ...
    it('should return empty', async () => {
      const xml = fs.readFileSync(
        path.resolve(__dirname, '../../mocks/alle-examen-momenten-leeg.xml'),
        'utf-8',
      )
      const res = alleExamenMomentenToJs(xml, LabelTypes.groenkeur)
