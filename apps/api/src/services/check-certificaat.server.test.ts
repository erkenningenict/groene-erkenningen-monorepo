...
//     const xml = fs.readFileSync('./mocks/check-certificaat-new1.xml', 'utf-8')
...
//     const spy = vi.spyOn(utils, 'getSoapBody')
//     // const spyEnvs = vi.spyOn(utils, 'getStringEnvVar')
//     const xml = fs.readFileSync('./mocks/check-certificaat1.xml', 'utf-8')
...
//     const spy = vi.spyOn(utils, 'getSoapBody')
//     // const spyEnvs = vi.spyOn(utils, 'getStringEnvVar')
//     const xml = fs.readFileSync('./mocks/geboortejaar-nil-new1.xml', 'utf-8')
...
//       './mocks/geboortejaar-nil-array-new1.xml',
//       'utf-8',
//     )
